    ...
    <section
      ...
      <div className="relative z-20 flex flex-col items-center">
        <Image
          ...
          alt={sectionData.data.logo.data.attributes.alt || ""}
          width={sectionData.data.logo.data.attributes.width}
          height={sectionData.data.logo.data.attributes.height}
      ...
      <Image
        ...
        alt={sectionData.data.backgroundImage.data.attributes.alt || ""}
        width={1920}
        height={1080}
